  ...
  page.open(address, function (status) {
    if (status !== 'success') {
      ...
      var pornKeywordsCount = page.evaluate(function () {
        ...
        var pornRegex = /(porn|pr0n|boobs|sex|bdsm|pov|teen|gay|pussy|nude|naked|breast|cock|dick|erotic|virgin|amateure|mature|cumming|facial|horny|orgasm|wife|anal)(\W|$)/gi
